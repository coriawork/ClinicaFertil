      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Link to="/medico/agenda">
                <Card className="card-3d-hover bg-primary/80 hover:shadow-lg ">
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm text-background font-medium">Citas Hoy</CardTitle>
                ...
                <Card className="card-3d-hover bg-primary/80 hover:shadow-lg">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm text-background font-medium">Tratamientos en Curso</CardTitle>
                ...
                <Card className="card-3d-hover bg-primary/80 hover:shadow-lg">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm text-background font-medium">Estudios Pendientes</CardTitle>
